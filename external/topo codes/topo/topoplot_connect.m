...
EMARKERSIZE = 50;       % default depends on number of electrodes, set in code
...
for kk = 1:numChanPairs
  % plot3(y(displayStruct.chanPairs(kk, :)), x(displayStruct.chanPairs(kk, :)), [ELECTRODE_HEIGHT, ELECTRODE_HEIGHT], 'LineWidth', 10*displayStruct.connectThickness(kk), 'Color', cM(cmapPos(kk), :)); 
  plot3(y(displayStruct.chanPairs(kk, :)), x(displayStruct.chanPairs(kk, :)), [ELECTRODE_HEIGHT, ELECTRODE_HEIGHT], 'LineWidth', 3, 'Color', 'k'); 
end
%colorbar
set(gcf, 'color', BACKCOLOR);
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%commented for showing only sig
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%connect%%%%%%%%%%%%%
%set(gca, 'CLim', [displayStruct.connectStrengthLimits(1) displayStruct.connectStrengthLimits(2)]) 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
return;